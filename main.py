...
class MenuPage:
    def __init__(self, parent):
      ...
      #Start button.
      self.start_button = Button(self.quiz_frame, text="START", font=("Helvetica", "14", 'bold'), foreground = 'black', bg= '#D9EAD3', highlightthickness=2, highlightbackground='black',  activebackground='light gray')
...
class DarkMenuPage:
    def __init__(self, parent):
      ...
      #Label widget for heading.
      self.heading_label=Label(self.quiz_frame, text="Mental Health Quiz", font=("Helvetica", "22", "bold"), foreground = 'white', bg = background_color2, highlightthickness=2, highlightbackground='white') #The label is text.
      self.heading_label.grid(row=1, column=2, padx=10)

      #Subtitle text.
      self.user_label=Label(self.quiz_frame, text="Hi there! Welcome to the mental health quiz. \n Please enter your name below and press start to begin:", font=("Helvetica","14"), foreground = 'white', bg=background_color2)
      self.user_label.grid(row=2, column=2, padx=60, pady=20)
      ...
      #Start button.
      self.start_button = Button(self.quiz_frame, text="START", font=("Helvetica", "14", 'bold'), foreground = 'white', bg= '#775144', highlightthickness=2, highlightbackground='white',  activebackground='light gray')
      self.start_button.grid(row=4, column=2, padx=20, pady=30, ipadx=30, ipady=10)

      #Dark theme button.
      self.theme1_button = Button(self.quiz_frame, text="Dark theme", font=("Helvetica","12", 'bold'), foreground = 'white', bg=background_color, padx=10, pady=10, background = "dark gray", highlightthickness=2, highlightbackground='white', activebackground='light gray', relief= FLAT)
      self.theme1_button.grid(row=0, column=1)
